const Footer = () => {
  return (
    <footer className="bg-[#1a365d] text-white py-8 border-t-4 border-[#ed8936]">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* 关于我们 */}
          <div className="animate-pixel-fade-in">
            <h3 className="text-lg font-bold mb-4 font-pixel">关于我们</h3>
            <p className="text-gray-300 text-xs font-pixel leading-relaxed">
              基于Python的数据分析在线教育平台，为商务数据分析与应用专业的学生提供系统化的学习资源和实践环境。
            </p>
          </div>

          {/* 快速链接 */}
          <div className="animate-pixel-fade-in" style={{ animationDelay: '0.1s' }}>
            <h3 className="text-lg font-bold mb-4 font-pixel">快速链接</h3>
            <ul className="space-y-2 text-xs text-gray-300 font-pixel">
              <li><a href="/" className="hover:text-[#ed8936] transition-colors hover:scale-105 transition-transform">首页</a></li>
          ...
          <div className="animate-pixel-fade-in" style={{ animationDelay: '0.2s' }}>
            <h3 className="text-lg font-bold mb-4 font-pixel">联系我们</h3>
            <ul className="space-y-2 text-xs text-gray-300 font-pixel">
              <li>邮箱: contact@pydata-edu.com</li>
          ...
          <div className="animate-pixel-fade-in" style={{ animationDelay: '0.3s' }}>
            <h3 className="text-lg font-bold mb-4 font-pixel">关注我们</h3>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-300 hover:text-[#ed8936] transition-colors animate-pixel-bounce">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
                </svg>
              </a>
              <a href="#" className="text-gray-300 hover:text-[#ed8936] transition-colors animate-pixel-bounce" style={{ animationDelay: '0.2s' }}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="text-gray-300 hover:text-[#ed8936] transition-colors animate-pixel-bounce" style={{ animationDelay: '0.4s' }}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
