      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-8 mb-12">
          <div className="lg:w-2/3">
            <h1 className="text-3xl font-bold text-[#1a365d] mb-4">{course.title}</h1>
            <div className="flex items-center mb-4">
                  ...
                  <div className="flex items-center ml-4">
                    ...
                    <span className="ml-2 text-gray-500">({course.reviewCount} 评价)</span>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <button 
                  ...
                  className="w-full py-3 bg-[#ed8936] text-white rounded-md hover:bg-[#d69e4f] transition-colors font-medium"
                >
                  立即报名
                </button>
                <button className="w-full mt-3 py-3 border border-[#4299e1] text-[#4299e1] rounded-md hover:bg-[#4299e1] hover:text-white transition-colors font-medium">
                  加入收藏
                </button>
              </div>
            </div>
        ...
        <div className="border-b border-gray-200 mb-8">
          <ul className="flex flex-wrap -mb-px text-sm font-medium text-center" id="course-tabs" role="tablist">
            <li className="mr-2" role="presentation">
              <button
                className={`inline-block p-4 border-b-2 rounded-t-lg ${activeTab === 'overview' ? 'border-[#4299e1] text-[#4299e1]' : 'border-transparent hover:text-gray-600 hover:border-gray-300'}`}
            ...
            <li className="mr-2" role="presentation">
              <button
                className={`inline-block p-4 border-b-2 rounded-t-lg ${activeTab === 'curriculum' ? 'border-[#4299e1] text-[#4299e1]' : 'border-transparent hover:text-gray-600 hover:border-gray-300'}`}
            ...
            <li className="mr-2" role="presentation">
              <button
                className={`inline-block p-4 border-b-2 rounded-t-lg ${activeTab === 'instructor' ? 'border-[#4299e1] text-[#4299e1]' : 'border-transparent hover:text-gray-600 hover:border-gray-300'}`}
            ...
            <li role="presentation">
              <button
                className={`inline-block p-4 border-b-2 rounded-t-lg ${activeTab === 'reviews' ? 'border-[#4299e1] text-[#4299e1]' : 'border-transparent hover:text-gray-600 hover:border-gray-300'}`}
              ...
              {course.modules.map((module) => (
                <div key={module.id} className="mb-6">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="text-lg font-bold text-[#1a365d]">{module.title}</h3>
                  </div>
                  <div className="mt-2 space-y-2">
                    {module.lessons.map((lesson) => (
                      <div key={lesson.id} className="flex items-center p-3 border border-gray-200 rounded-lg">
                        <div className="w-8 h-8 bg-[#4299e1] rounded-full flex items-center justify-center text-white font-medium mr-3">
                          {lesson.id.split('-')[1]}
                        </div>
              ...
              <div className="md:w-1/4">
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                  <div className="p-6">
                    ...
                    <h3 className="text-xl font-bold text-center mb-2">{course.instructor.name}</h3>
                    <p className="text-gray-600 text-center mb-4">{course.instructor.title}</p>
                  </div>
                </div>
              </div>
              <div className="md:w-3/4">
                <h2 className="text-2xl font-bold mb-4">关于讲师</h2>
              ...
              <div className="mb-8">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{course.reviewCount} 条评价</p>
                  </div>
                </div>
              </div>
