...
const Courses = () => {
  ...
  const courses = [
    ...
    },
    {
      ...
      level: 'beginner',
      rating: 4.5,
      image: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=pixel%20art%20SQL%20database%20course%208-bit%20style&image_size=landscape_16_9'
    },
    {
      id: '6',
      title: '大数据分析',
      ...
      level: 'advanced',
      rating: 4.8,
      image: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=pixel%20art%20big%20data%20analysis%208-bit%20style&image_size=landscape_16_9'
    }
  ];
    ...
    <div className="py-12">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 animate-pixel-fade-in">
          <h1 className="text-3xl font-bold text-[#1a365d] mb-4 font-pixel">课程列表</h1>
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-4">
            ...
            <div className="flex gap-4">
              <select
                ...
                className="px-4 py-2 border-2 border-[#1a365d] rounded-md focus:outline-none focus:ring-2 focus:ring-[#ed8936] font-pixel text-sm"
              >
        ...
        {filteredCourses.length === 0 && (
          <div className="text-center py-12 animate-pixel-fade-in">
            <p className="text-gray-600 font-pixel">没有找到匹配的课程</p>
          </div>
        )}
      </div>
    </div>
